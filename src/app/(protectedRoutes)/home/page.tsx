        ...
        <div className="w-full mx-auto h-full space-y-12">
            ...
            <div className="w-full flex flex-col lg:flex-row justify-between items-start gap-12">
                <div className="space-y-8 flex-1">
                    <div className="space-y-4">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-white/20 backdrop-blur-sm">
                            ...
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">AI-Powered Customer Experience</span>
                        </div>
                ...
                <div className="grid grid-cols-1 gap-6 place-content-center w-full lg:w-auto">
                    <FeatureCard
                        ...
                        description="Intelligent voice conversations that qualify leads and drive conversions"
                        link="#"
                    />
                    <FeatureCard
                        Icon={<Webcam className="w-12 h-12 text-blue-600 dark:text-blue-400"/>}
                        heading="Real-Time Personalization"
                        description="Dynamic content that adapts to each customer&apos;s journey"
                        link="/webinars"
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <FeatureSectionLayout
                    heading="AI-Powered Customer Intelligence"
                    link="/lead"
                >
