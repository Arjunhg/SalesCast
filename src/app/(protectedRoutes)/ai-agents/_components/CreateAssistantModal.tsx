    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl">
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="text-2xl font-bold text-gray-900 dark:text-white">Create Assistant</DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-6">
          <div className="space-y-3">
            <label className="block font-semibold text-gray-900 dark:text-white">Assistant Name</label>
            <Input
              value={name}
